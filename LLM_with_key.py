...
qianwen_client = OpenAI(
    api_key="sk-1d386b33b747443bbd5655e9d2ad351b",
    base_url="https://dashscope.aliyuncs.com/compatible-mode/v1"
)

openai_client = OpenAI(
            base_url="https://svip.xty.app/v1", 
            api_key="sk-UY2xHKB08Q8a4GQd1722Bc54683f417bBcB83fE7B18909Df",
...
def LLM(query, model_name):
    ...
    if model_name.find("gpt") != -1:
        ...
        apis = ['2dc8291a45880410ee0796565841fd91.qjjMjdjdKoUK1Czp','c2b3342974229b07645b51b099577a02.xWtSKHmKU05WLRmd',
        '66be964d50c1b72a02127446bfc704a8.LWt68awiViiAYAJ1','a612c46dcd9a7c4bc21e975a754bc7b8.1YWLNCy6MDMnZAJE']
        random_number = random.choice([0, 1, 2, 3])
        client = ZhipuAI(api_key=apis[random_number])
